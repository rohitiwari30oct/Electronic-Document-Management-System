...
<!----------------/// LEft Portion End Here ----------------->
 <div id="tab22" class="user_static tab_content_1">
      ...
      <div class="main_statical"> 
      
      <!----------------// TRASH ICON STARED HERE ------------>
           <div class="trash_menu">
                   ...
                   <div class="trash_right">
                       <ul>
                           ...
                           <li class="trash_3"><a href="#"></a></li>
                           <li class="trash_4"><a href="#"></a></li>
                       </ul>
                   </div>
           </div>
      <!-------------------/// Trash Icon End Here ---------------->
      <div class="claer"></div>
      <div class="folder_space_11"></div>
      <!---------------TRASH FOLDER IS GIVEN BELOW ---------------->
      <div class="row_content_folder">
          <ul>
            ...
            <li>
              ...
              list_perimission_5</span> </li>
            <li>
              <div class="recnt_pdf_doc_1"> </div>
              <div class="claer"></div>
              <span>admin_user_<br>
              list_perimission_5</span> </li>
              <li>
               <div class="recnt_pdf_1"> </div>
               <div class="claer"></div>

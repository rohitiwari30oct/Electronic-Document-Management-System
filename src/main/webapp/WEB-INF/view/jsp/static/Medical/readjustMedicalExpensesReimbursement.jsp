            ...
            -->    <option value="Sales Coordinator">Sales Coordinator</option> 
              ...
              <td width="35%">Eligibility </td>
               <td width="30%"> Availed	Balance</td>
                ...
                <tr>
                  <td width="35%"> <input type="text" disabled="disabled"  onblur="myVal(this.id);abc()" class="emple_np"   id="Eligibility" placeholder=""/></td>
                  <td width="30%"> <input type="text" disabled="disabled" onblur="myVal(this.id);abc()" class="emple_np"   id="AvailedBalance"  placeholder=""/></td>
                   <td width="35%"><input type="text" disabled="disabled" onblur="myVal(this.id);abc()" class="emple_np"   id="Available" placeholder=""/> </td>
                  </tr>

		...
		<div class="from_main_leave">
			...
			<tr>
              <td width="10%"><img src="images/logo.png"></td>
               ...
               <td width="10%">Date:<input type="text" onblur="myVal(this.id)" value="<%=dt %>" id="curr_Date"  name="curr_Date" class="emple_date" placeholder="dd-MM-yyyy"></td>
            ...
            -->    <option value="Sales Coordinator">Sales Coordinator</option> 
              ...
              <tr>
                ...
                <table width="100%"><tr><td  width="10%">  <label><input type="radio" onclick="setHClaim(this.value)" name="hClaim" id="hClaimNo" value="No"/>
							No</label></td>
                ...
                <td width="20%">DOA: <input type="text"  onblur="myVal(this.id)" class="emple_date" id="hName" placeholder="dd-MM-yyyy"> </td>
               
                <td width="20%">DOD: <input type="text"  onblur="myVal(this.id)" class="emple_date" id="hDate" placeholder="dd-MM-yyyy"></td>
                </table>
               </td>
               </tr>
               ...
               <tr>
                ...
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="consultation1" class="emple_table blank_val only_num" value="0" /> </td>
                <td width="20%"> <input type="text"  onblur="myVal(this.id)" id="medicines1" class="emple_table blank_val only_num"  value="0" /></td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="hCharges1" class="emple_table blank_val only_num" value="0"  /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="others1" class="emple_table blank_val only_num"  value="0" /> </td>
                </tr>
               ...
               <tr id="tr_2" style="display: none;">
                ...
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="consultation2" class="emple_table" value="0" /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="medicines2" class="emple_table"  value="0" /></td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="hCharges2" class="emple_table" value="0"  /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="others2" class="emple_table"  value="0" /> </td>
                </tr>
              ...
              <td width="10%"><input type="text"  onblur="myVal(this.id)" id="pName3" class="emple_table" /> </td>
                ...
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="consultation3" class="emple_table" value="0" /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="medicines3" class="emple_table" value="0"  /></td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="hCharges3" class="emple_table" value="0"  /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="others3" class="emple_table"  value="0" /> </td>
                </tr>
              ...
              <td width="10%"><input type="text"  onblur="myVal(this.id)" id="pName10" class="emple_table" /> </td>
               ...
               <td width="10%"><button onclick="grandTotal()">Grand Total</button> </td>
                <td width="50%" colspan="4"> <input type="text"  onblur="myVal(this.id)" class="blank_val emple_table" id="gtotal" style="width: 100%"/> </td>
                </tr>
                </table>
                </td>
                </tr>
             ...
             <tr>
                <td style="display: none;" width="30%" colspan="2">
               ...
               HOD/CEO (Approver) <!-- <input type="text"  onblur="myVal(this.id)" class="emple_np" id="approvalStep" placeholder="Email"/> -->
              ...
              <td width="35%">Eligibility </td>
               <td width="30%"> Availed	Balance</td>
                ...
                <tr>
                   <td width="35%"> <input type="text"  onblur="myVal(this.id);abc()" class="emple_np"   id="Eligibility" placeholder=""/></td>
                  <td width="30%"> <input type="text"  onblur="myVal(this.id);abc()" class="emple_np"   id="AvailedBalance"  placeholder=""/></td>
                   <td width="35%"><input type="text"  onblur="myVal(this.id);abc()" class="emple_np"   id="Available" placeholder=""/> </td>
                 </tr>
						...
						<table>
							<tr>
								...
								<td width="85%"><input type="text" onblur="myVal(this.id)"
									...
									value="<%=uid%>" id="employeeID" name="employeeID" /></td>
							</tr>
						</table>
					...
					<td colspan="8">
						<table>
							<tr>
								...
								<td width="85%"><input type="text" onblur="myVal(this.id)"
									style="width: 65% !important; border: 0px;" readonly="readonly"
									value="" id="verifiedBy" name="verifiedBy" /></td>
							</tr>
						</table>
					...
					<td colspan="8">
						<table>
							<tr>
								...
								<td width="85%"><input type="text" onblur="myVal(this.id)"
									style="width: 65% !important; border: 0px;" readonly="readonly"
									value="" id="approvedBy" name="approvedBy" /></td>
							</tr>
						</table>
						...
						<table>
							<tr>
								<td width="100%"><input type="hidden"
									id="historyHiddenTasks" value="" />
									<div id="showHistoryHiddenTasks">
										<input type="button" onclick="getHistoryForms()"
											class="getHistory" value="Get History" />
				...
				<tr >
					...
					<td colspan="8"><div class="table_right">
						 <!----------/// ADD USER ----------->
								...
								<input type="button" class="Logged_User_tab  onclick" id="medirej"

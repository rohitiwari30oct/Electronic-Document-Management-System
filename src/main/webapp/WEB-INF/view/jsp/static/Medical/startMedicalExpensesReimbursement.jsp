...
function grandTotal(){
	...
	for(var i=1;i<=count;i++){
		if($("#consultation"+i).val()!="")
		total1 = total1 +  parseFloat($("#consultation"+i).val());
		else
			$("#consultation"+i).attr("value",'0');
		if($("#medicines"+i).val()!="")
		total2 = total2 +  parseFloat($("#medicines"+i).val());
		else
			$("#medicines"+i).attr("value",'0');
			
		if($("#hCharges"+i).val()!="")
		total3 = total3 +  parseFloat($("#hCharges"+i).val());
		else
			$("#hCharges"+i).attr("value",'0');
		if($("#others"+i).val()!="")
		total4 = total4 +  parseFloat($("#others"+i).val());
		else
			$("#others"+i).attr("value",'0');
	}
	$("#total1").attr('value',total1);
	$("#total2").attr('value',total2);
	$("#total3").attr('value',total3);
	$("#total4").attr('value',total4);
	$("#gtotal").attr('value',total1+total2+total3+total4);
	//alert(total1);
}
...
/* 		 else  if($("#Eligibility").val()==null || $("#Eligibility").val().trim()=="")
		{
		pg=false;
		showMsgWF("Please Fill Eligibility");
		}
		else  if($("#AvailedBalance").val()==null || $("#AvailedBalance").val().trim()=="")
		{
		pg=false;
		showMsgWF("Please Fill AvailedBalance");
		}
		else  if($("#Available").val()==null || $("#Available").val().trim()=="")
		{
		pg=false;
		showMsgWF("Please Fill Available");
		}  */
		...
		if(pg==true)
			...
			submitForm_MedicalReimbursement('MedicalReimbursementRequest::REIMBURSEMENT OF MEDICAL EXPENSES');
			}
		else
			{
...
{
//	alert("hii");
$(':radio[name="hClaim"]').removeAttr('checked');
...
<!-- <script type="text/javascript">
				function abc(){
					...
					var a=$('#Eligibility').val();
					var b=$('#AvailedBalance').val();
				if(a&&b){
					$('#Available').val((a-b));
				}
...
String eno="";
 ...
 Attribute att1 = testAttributes.get("employeeNumber");
 if(att1 != null)
 {
	  eno = (String) att1.get();
 }
...
%>
	<div class="form_scolling_project" id="myformMedi">
		<div class="from_main_leave">
			...
			<tr>
              ...
              <tr>
                ...
                <table width="100%"><tr><td width="20%">Name</td>
                <td width="80%"> 	<input type="text"  onblur="myVal(this.id)" value="<%=uname %>" id="empName"  class="emple_np" placeholder="Name of the Employee"></td></tr></table>
               </td>
                <td  colspan="3">
                <table width="100%"><tr><td width="40%">Employee No.</td>
                <td width="60%">	<input type="text"  onblur="myVal(this.id)" placeholder="Employee No." id="empNo" value="<%=eno %>" /></td></tr></table>
               </td>
                <td  colspan="2">
            ...
            -->    <option value="Sales Coordinator">Sales Coordinator</option> 
              ...
              <tr>
                ...
                <table width="100%"><tr><td  width="10%">  <label><input type="radio" checked="checked" onclick="setHClaim(this.id)" name="hClaim" id="hClaimNo" value="No"/>
							No</label></td>
                <td width="90%"><label><input type="radio" onclick="setHClaim(this.id)" name="hClaim" id="hClaimYes" value="Yes"/>
							Yes </label> </td></tr></table>	
                </td></tr>
                <tr>
                <td width="10%">if Yes,</td>
                <td width="20%">Name of the Hospital</td>
                <td width="30%"><input type="text"  onblur="myVal(this.id)" id="HosName" class="emple_np" /></td>
               ...
               <tr>
                ...
                <tr><td width="20%"><input type="text"  onblur="myVal(this.id)" id="pName1" class="emple_table blank_val" /> </td>
                <td width="10%"><input type="text"  onblur="myVal(this.id)" id="relation1" class="emple_table blank_val" /> </td>
                <td width="10%"><input type="text"  onblur="myVal(this.id)" id="recNo1" class="emple_table blank_val" /> </td>
                ...
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="consultation1" class="emple_table blank_val only_num"  /> </td>
                <td width="20%"> <input type="text"  onblur="myVal(this.id)" id="medicines1" class="emple_table blank_val only_num"   /></td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="hCharges1" class="emple_table blank_val only_num"  /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="others1" class="emple_table blank_val only_num"  /> </td>
                </tr>
               ...
               <tr id="tr_2" style="display: none;">
                ...
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="consultation2" class="emple_table only_num"  /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="medicines2" class="emple_table only_num"  /></td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="hCharges2" class="emple_table only_num"  /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="others2" class="emple_table only_num"   /> </td>
                </tr>
              ...
              <td width="10%"><input type="text"  onblur="myVal(this.id)" id="pName3" class="emple_table" /> </td>
                ...
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="consultation3" class="emple_table only_num"  /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="medicines3" class="emple_table only_num"   /></td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="hCharges3" class="emple_table only_num"   /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="others3" class="emple_table only_num"   /> </td>
                </tr>
              ...
              <td width="10%"><input type="text"  onblur="myVal(this.id)" id="pName4" class="emple_table" /> </td>
                ...
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="consultation4" class="emple_table only_num"/> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="medicines4" class="emple_table only_num" /></td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="hCharges4" class="emple_table only_num" /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="others4" class="emple_table only_num" /> </td>
                </tr>
              ...
              <td width="10%"><input type="text"  onblur="myVal(this.id)" id="pName5" class="emple_table" /> </td>
                ...
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="consultation5" class="emple_table only_num"/> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="medicines5" class="emple_table only_num" /></td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="hCharges5" class="emple_table only_num" /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="others5" class="emple_table only_num" /> </td>
                </tr>
              ...
              <td width="10%"><input type="text"  onblur="myVal(this.id)" id="pName6" class="emple_table" /> </td>
                ...
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="consultation6" class="emple_table only_num"/> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="medicines6" class="emple_table only_num" /></td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="hCharges6" class="emple_table only_num" /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="others6" class="emple_table only_num" /> </td>
                </tr>
              ...
              <td width="10%"><input type="text"  onblur="myVal(this.id)" id="pName7" class="emple_table" /> </td>
                ...
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="consultation7" class="emple_table only_num"/> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="medicines7" class="emple_table only_num" /></td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="hCharges7" class="emple_table only_num" /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="others7" class="emple_table only_num" /> </td>
                </tr>
              ...
              <td width="10%"><input type="text"  onblur="myVal(this.id)" id="pName8" class="emple_table" /> </td>
                ...
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="consultation8" class="emple_table only_num"/> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="medicines8" class="emple_table only_num" /></td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="hCharges8" class="emple_table only_num" /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="others8" class="emple_table only_num" /> </td>
                </tr>
              ...
              <td width="10%"><input type="text"  onblur="myVal(this.id)" id="pName9" class="emple_table" /> </td>
                ...
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="consultation9" class="emple_table only_num"/> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="medicines9" class="emple_table only_num" /></td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="hCharges9" class="emple_table only_num" /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="others9" class="emple_table only_num" /> </td>
                </tr>
              ...
              <td width="10%"><input type="text"  onblur="myVal(this.id)" id="pName10" class="emple_table" /> </td>
                ...
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="consultation10" class="emple_table only_num"/> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="medicines10" class="emple_table only_num" /></td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="hCharges10" class="emple_table only_num" /> </td>
                <td width="10%"> <input type="text"  onblur="myVal(this.id)" id="others10" class="emple_table only_num" /> </td>
                </tr>
                ...
                <tr><td width="40%" colspan="3"> </td>
                <td width="10%"><button onclick="grandTotal()">Grand Total</button> </td>
              ...
              <tr>
              <td colspan="8">
              A.	Domiciliary Entitlement Block Year  <span id="financialYear">2016-17</span><br>
              ...
              <tr>
               ...
               <div id="showHistoryHiddenTasks" >
                       ...
                       <!-- <tr >
                                <td class="rupee_td" colspan="8">
                                <table ><tr><td width="10%">
                                          Attachment</td><td width="90%">
                                         <input type="file" class="emple_1">
                                </td></tr></table>

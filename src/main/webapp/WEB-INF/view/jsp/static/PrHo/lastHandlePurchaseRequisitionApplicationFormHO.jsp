...
function addTrTable() {
	...
	"<td><input type='text' class='serial_no' placeholder='No' id='serialNo"+hid_val+"' name='serialNo"+hid_val+"' /></td>"+
	"<td><input type='text' placeholder='Item Code' id='itemCode"+hid_val+"' name='itemCode"+hid_val+"' /></td>"+
	"<td><input type='text' placeholder='Description' id='itemDescription"+hid_val+"' name='itemDescription"+hid_val+"' /></td>"+
	"<td><input type='text' placeholder='Unit' id='itemUnit"+hid_val+"' name='itemUnit"+hid_val+"' /></td>"+
	"<td><input type='text' placeholder='Packing' id='itemPacking"+hid_val+"' name='itemPacking"+hid_val+"' /></td>"+
	"<td><input type='text' placeholder='Quantity' id='itemQuantity"+hid_val+"' name='itemQuantity"+hid_val+"'  /></td>"+
	"<td><input type='text' placeholder='Source' id='itemSource"+hid_val+"' name='itemSource"+hid_val+"' /></td></tr>"; */
...
function checkMail(id){
	...
	if(pg==true)
		...
		try{
			...
			today = dd+'-'+mm+'-'+yyyy;
			$('#historyHiddenTasks').attr("value",$('#historyHiddenTasks').val()+"Request Recieved By " + $("#formBy").val()+" on Dated "+today+",") ;
			$('#formSStatus').attr("value","Request Recieved") ;
...
<tr>
                ...
                <input type="hidden"  name="formSStatus"  id="formSStatus" />
                 <input type="hidden" value="<%=dt %>" name="lastDatte" id="lastDatte" />
					...
					<td colspan="2">
						P.R.No: 
						<input type="text" onblur="myVal(this.id)" id="prNo" name="prNo" disabled="disabled"  class="small_medical" placeholder="Enter P.R.No">
					</td>
				</tr>
				<tr >
					<td colspan="2" >
						Date &nbsp;&nbsp;&nbsp;&nbsp;
						<input	type="text" onblur="myVal(this.id)"  disabled="disabled" id="todaysDate" name="todaysDate" class="small_medical popupDatepicker" placeholder="dd-MM-yyyy">
					</td>
				</tr>
					<tr>
				<td colspan="8">
				...
				<tr>
					...
					Name: <br>
					<input disabled="disabled"   type="text" onblur="myVal(this.id)" id="empName" name="empName" value="" placeholder="Name"/>	
					<input type="hidden" id="formName" name="formName" value="Purchase Requisition Application" placeholder="Name"/>	
					</td>
					<td  colspan="2"  class="clearBorderRight" >
					Email:  <br>
					<%-- <input disabled="disabled"   id="formBy" name="formBy" type="text" onblur="myVal(this.id)" value="<%=uid %>" class="small_medical" placeholder="emailid" /> --%>
               ...
               <%} %>
                ...
                <td width="85%"><input type="text" onblur="myVal(this.id)"   onblur="myVal(this.id)" style="width: 65% !important; border: 0px;" readonly="readonly"  value="<%=uid %>" id="employeeID" name="employeeID"  /></td>
                </tr>
                </table>
              ...
              <tr>
               ...
               <table>
                ...
                <td width="85%"><input type="text" onblur="myVal(this.id)"   onblur="myVal(this.id)" style="width: 65% !important; border: 0px;" readonly="readonly" value="" id="verifiedBy" name="verifiedBy"  /></td>
                </tr>
                </table>
              ...
              <tr>
               <td colspan="8">
                ...
                <td width="85%"><input type="text" onblur="myVal(this.id)"   onblur="myVal(this.id)" style="width: 65% !important; border: 0px;" readonly="readonly"  value="" id="approvedBy" name="approvedBy"  /></td>
                </tr>
                </table>
				...
				<tr>
						...
						<td colspan="8"><div class="table_right">
								...
								<!-- <input type="button" class="Logged_User_tab  onclick"
									value="REJECT" onclick="checkMail('reject')"> -->
								<!----------/// User List END -------->
<input type="button"
								class="Logged_User_tab_color add_user_js add_user_bg"
								value="Print"

...
function remTrTable() {
	...
	if(i>1)
	{
		 ...
		 $("#serialNo"+i).removeClass("blank_val");
		 $("#itemCode"+i).removeClass("blank_val");
		 $("#itemDescription"+i).removeClass("blank_val");
		 $("#itemUnit"+i).removeClass("blank_val");
		 $("#itemPacking"+i).removeClass("blank_val");
		 $("#itemQuantity"+i).removeClass("blank_val");
		// $("#itemSource"+i).removeClass("blank_val");
		...
		<div class="from_main_leave">
			<table id="handleWorkflowForm">
                ...
                <input type="hidden"  name="formSStatus"  id="formSStatus" />
					...
					<td colspan="2">
						P.R.No: 
						<input type="text"  onblur="myVal(this.id)" id="prNo" name="prNo"  readonly="readonly" readonly="readonly" value="PR/HO/1516/" class="small_medical" placeholder="Enter P.R.No">
					</td>
				</tr>
				<tr >
					<td colspan="2" >

...
function remTrTable() {
	...
	if(i>1)
	{
		...
		// $("#voucherP"+i).removeClass("blank_val");
		 $('#vrec_'+i).hide();
		 $("#hid_tr_val").val(i-1);
	}
}
...
function valiFormCPV(id)
{
	...
	if(pg==true)
		...
		submitForm_CashPayment('cashPaymentVoucherRequest::Cash Payment Voucher Request')
		}
	else
		{
		...
		<div class="from_main_leave">
              ...
              <td colspan="1" width="20%"><img src="images/logo.png"></td>
                ...
                <input type="hidden" value="Initiated" name="formSStatus"  id="formSStatus" />
                  ...
                  <td width="20%" class="voucher">
                    ...
                    <input type="text" onblur="myVal(this.id)" id="todaysDate" name="todaysDate"  class="blank_val popupDatepicker" placeholder="dd-MM-yyyy"  value="<%=dt %>">
             ...
             <%--   <input type="text" class="blank_val"  onblur="myVal(this.id)" style="width: 80%;" value="<%=uid %>"  id="formBy" name="formBy" /> --%>
              ...
              <input type="hidden" name="hid_tr_val" id="hid_tr_val" value="1">
                ...
                <td colspan="2"><textarea   onblur="myTextareaVal(this.id)" id="voucherParticular1" class="blank_val"  style="width: 99% !important;height:80px;"  name="voucherParticular1" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
                <tbody><tr><td width="65%"><input class="blank_val only_num" type="text"  onblur="myVal(this.id)" id="voucherRs1" name="voucherRs1"   placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%">
              ...
              <td><input type="text"  onblur="myVal(this.id)" id="voucherDate2" name="voucherDate2" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                <td colspan="2"><textarea rows="2" cols="25"  onblur="myTextareaVal(this.id)" id="voucherParticular2" style="width: 99% !important;height:80px;"  name="voucherParticular2" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
			  ...
			  <tr  style="display: none;" id="vrec_3">
                ...
                <td colspan="2"><textarea rows="2" cols="25"  onblur="myTextareaVal(this.id)" id="voucherParticular3" style="width: 99% !important;height:80px;"  name="voucherParticular3" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
			  ...
			  <tr style="display: none;" id="vrec_4">
                ...
                <td colspan="2"><textarea rows="2" cols="25"  onblur="myTextareaVal(this.id)" id="voucherParticular4" style="width: 99% !important;height:80px;"  name="voucherParticular4" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
			  ...
			  <tr style="display: none;" id="vrec_5">
                ...
                <td colspan="2"><textarea rows="2" cols="25"  onblur="myTextareaVal(this.id)" id="voucherParticular5" style="width: 99% !important;height:80px;"  name="voucherParticular5" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
			  ...
			  <tr  style="display: none;"  id="vrec_6">
                ...
                <td colspan="2"><textarea rows="2" cols="25"  onblur="myTextareaVal(this.id)" id="voucherParticular6" style="width: 99% !important;height:80px;"  name="voucherParticular6" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
			  ...
			  <tr style="display: none;" id="vrec_7">
                ...
                <td colspan="2"><textarea rows="2" cols="25"  onblur="myTextareaVal(this.id)" id="voucherParticular7" style="width: 99% !important;height:80px;"  name="voucherParticular7" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
			  ...
			  <tr style="display: none;" id="vrec_8">
                ...
                <td colspan="2"><textarea rows="2" cols="25"  onblur="myTextareaVal(this.id)" id="voucherParticular8" style="width: 99% !important;height:80px;"  name="voucherParticular8" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
			  ...
			  <tr style="display: none;" id="vrec_9">
                ...
                <td colspan="2"><textarea rows="2" cols="25"  onblur="myTextareaVal(this.id)" id="voucherParticular9" style="width: 99% !important;height:80px;"  name="voucherParticular9" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
			  ...
			  <tr style="display: none;" id="vrec_10">
                ...
                <td colspan="2"><textarea rows="2" cols="25"  onblur="myTextareaVal(this.id)" id="voucherParticular10" style="width: 99% !important;height:80px;"  name="voucherParticular10" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
			  ...
			  <tr style="display: none;" id="vrec_11">
                ...
                <td colspan="2"><textarea rows="2" cols="25"  onblur="myTextareaVal(this.id)" id="voucherParticular11" style="width: 99% !important;height:80px;"  name="voucherParticular11" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
			  ...
			  <tr style="display: none;" id="vrec_12">
                ...
                <td colspan="2"><textarea rows="2" cols="25"  onblur="myTextareaVal(this.id)" id="voucherParticular12" style="width: 99% !important;height:80px;"  name="voucherParticular12" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
			  ...
			  <tr style="display: none;" id="vrec_13">
                ...
                <td colspan="2"><textarea rows="2" cols="25"  onblur="myTextareaVal(this.id)" id="voucherParticular13" style="width: 99% !important;height:80px;"  name="voucherParticular13" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
			  ...
			  <tr style="display: none;" id="vrec_14">
                ...
                <td colspan="2"><textarea rows="2" cols="25"  onblur="myTextareaVal(this.id)" id="voucherParticular14" style="width: 99% !important;height:80px;"  name="voucherParticular14" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
			  ...
			  <tr style="display: none;" id="vrec_15">
                ...
                <td colspan="2"><textarea rows="2" cols="25"  onblur="myTextareaVal(this.id)" id="voucherParticular15" style="width: 99% !important;height:80px;"  name="voucherParticular15" class="particular" placeholder="PARTICULARS "></textarea></td>
                <td class="rupee_td"> <table class="rupee">
             ...
             <tr>  
              ...
              <tr>
                 <td colspan="4"><div class="table_right">
								...
								value="Submit" id="CPVsubmit"
								onclick="valiFormCPV(this.id)" /> 

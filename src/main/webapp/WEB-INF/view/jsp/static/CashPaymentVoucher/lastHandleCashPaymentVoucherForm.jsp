...
function valiForm(id)
{
	...
	/* else if($("#voucherNo").val()==null || $("#voucherNo").val().trim()=="")
	{
	pg=false;
	showMsgWF("Please Fill Voucher No");
	} */
	...
	if(pg==true)
		...
		try{
			...
			today = dd+'-'+mm+'-'+yyyy;
			$('#historyHiddenTasks').attr("value",$('#historyHiddenTasks').val()+"Payment Released By " + $("#formBy").val()+" on Dated "+today) ;
			$('#accountBy').attr("value",$("#formBy").val()+" on Dated "+today) ;
		...
		<div class="from_main_leave">
              ...
              <td colspan="1" width="20%"><img src="images/logo.png"></td>
                ...
                <input type="hidden"  name="formSStatus"  id="formSStatus" />
                  ...
                  <td width="20%" class="voucher">
                    VOUCHER NO.
                    <input type="text" onblur="myVal(this.id)" id="voucherNo" name="voucherNo" placeholder=" VOUCHER NO"><br>
             ...
             <tr class="cash_1">
              ...
              <input type="hidden" name="hid_tr_val" id="hid_tr_val" value="1">
                <td><input type="text" disabled="disabled" id="voucherDate1" name="voucherDate1" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs1" name="voucherRs1" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table> </td>
              </tr>
               
               <tr  style="display: none;" id="vrec_2">
              <td><input type="text" disabled="disabled" id="voucherDate2" name="voucherDate2" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <td class="rupee_td"> <table class="rupee">
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs2" name="voucherRs2" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table> </td>
              </tr>
			  
			  
			  <tr  style="display: none;" id="vrec_3">
                <td><input type="text" disabled="disabled" id="voucherDate3" name="voucherDate3" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs3" name="voucherRs3" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table> </td>
              </tr>
			  
			  
			  <tr style="display: none;" id="vrec_4">
                <td><input type="text" disabled="disabled" id="voucherDate4" name="voucherDate4" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <td class="rupee_td"> <table class="rupee">
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs4" name="voucherRs4" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table> </td>
              </tr>
			  
			  
			  <tr style="display: none;" id="vrec_5">
                <td><input type="text" disabled="disabled" id="voucherDate5" name="voucherDate5" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <td class="rupee_td"> <table class="rupee">
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs5" name="voucherRs5" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table></td>
              </tr>
			  
			  <tr  style="display: none;"  id="vrec_6">
                <td><input type="text" disabled="disabled" id="voucherDate6" name="voucherDate6" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <td class="rupee_td"> <table class="rupee">
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs6" name="voucherRs6" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table> </td>
              </tr>
			  
			  <tr style="display: none;" id="vrec_7">
                <td><input type="text" disabled="disabled" id="voucherDate7" name="voucherDate7" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <td class="rupee_td"> <table class="rupee">
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs7" name="voucherRs7" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table> </td>
              </tr>
			  
			  <tr style="display: none;" id="vrec_8">
                <td><input type="text" disabled="disabled" id="voucherDate8" name="voucherDate8" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <td class="rupee_td"> <table class="rupee">
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs8" name="voucherRs8" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table></td>
              </tr>
			  
			  <tr style="display: none;" id="vrec_9">
                <td><input type="text" disabled="disabled" id="voucherDate9" name="voucherDate9" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <td class="rupee_td"> <table class="rupee">
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs9" name="voucherRs9" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table> </td>
              </tr>
			  
			  <tr style="display: none;" id="vrec_10">
                <td><input type="text" disabled="disabled" id="voucherDate10" name="voucherDate10" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <td class="rupee_td"> <table class="rupee">
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs10" name="voucherRs10" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table> </td>
              </tr>
			  
			  <tr style="display: none;" id="vrec_11">
                <td><input type="text" disabled="disabled" id="voucherDate11" name="voucherDate11" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <td class="rupee_td"> <table class="rupee">
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs11" name="voucherRs11" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table> </td>
              </tr>
			  
			  <tr style="display: none;" id="vrec_12">
                <td><input type="text" disabled="disabled" id="voucherDate12" name="voucherDate12" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <td class="rupee_td"> <table class="rupee">
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs12" name="voucherRs12" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table> </td>
              </tr>
			  
			  <tr style="display: none;" id="vrec_13">
                <td><input type="text" disabled="disabled" id="voucherDate13" name="voucherDate13" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <td class="rupee_td"> <table class="rupee">
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs13" name="voucherRs13" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table> </td>
              </tr>
			  
			  <tr style="display: none;" id="vrec_14">
                <td><input type="text" disabled="disabled" id="voucherDate14" name="voucherDate14" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <td class="rupee_td"> <table class="rupee">
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs14" name="voucherRs14" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table> </td>
              </tr>
			  
			  <tr style="display: none;" id="vrec_15">
                <td><input type="text" disabled="disabled" id="voucherDate15" name="voucherDate15" value="<%=dt %>" class="popupDatepicker" placeholder="dd-MM-yyyy"></td>
                ...
                <td class="rupee_td"> <table class="rupee">
                <tbody><tr><td width="65%"><input type="text" disabled="disabled" id="voucherRs15" name="voucherRs15" placeholder="Rs." style="width: 80% !important;"></td>
                 <td width="35%"></td> </tr></tbody></table> </td>
              </tr>
              ...
              <tr>
                <td colspan="3">AMOUNT IN WORDS:RUPEES <input type="text" disabled="disabled" style="width: 95% !important;" id="voucherAmt" name="voucherAmt"  class="particular" placeholder="Amount in Words"></td>
                <td colspan="1"><div class="payment"> <input type="text" disabled="disabled" id="voucherTotal" name="voucherTotal" placeholder="Total"><span style="  background: #ccc; padding: 4px; border-radius: 2px; cursor: pointer;" onclick="calTotal()">TOTAL </span></div></td>
              </tr>
              <tr>
            ...
            <input type="button" onclick="getHistoryForms()" class="getHistory"  value="Get History" />
                 ...
                 <td colspan="4"><div class="table_right">
								...
								<input type="button" id="AccCPV"
									class="Logged_User_tab_color add_user_js add_user_bg"
									value="SAVE" onclick="valiForm(this.id)">
								<!----------/// ADD USER END -------->
								<!----------/// User List ----------->

...
function checkVali(id){
	...
	<%--  if($("#authorizationStep").val().indexOf("<%=Config.EDMS_DOMAIN%>")<0||$("#verificationStep").val().indexOf("<%=Config.EDMS_DOMAIN%>")<0||$("#approvalStep").val().indexOf("<%=Config.EDMS_DOMAIN%>")<0)
		{
		pg=false;
		//alert("SDF");
		showMsgWF("Please Fill Correct Email Id");
		}
	 else{ --%>
		...
		if(pg==true)
			...
			try{
				...
				today = dd+'-'+mm+'-'+yyyy;
				$('#historyHiddenTasks').attr("value",$('#historyHiddenTasks').val()+"Initiated By " + $("#employeeId").val()+" on Dated "+today) ;
			 */	
			}
			catch (e) {
				// TODO: handle exception
...
function setNatureOfLeave(val)
{
//	alert("hii");
$(':radio[name="natureOfLeave"]').removeAttr('checked');
$(':radio[name="natureOfLeave"][value='+val+']').attr('checked', 'checked');
} 
 ...
 <div class="form_scolling_project" id="myformLeave">
			...
			<tr>
              ...
              <tr>
                ...
                <td width="60%">	<input type="text" onblur="myVal(this.id)" placeholder="Employee No." value="<%=eno %>" id="empNo"/></td></tr></table>
               </td>
              </tr>
             <tr>
                ...
                <select  name="empDesig" style="height: 28px;" id="empDesig">
            ...
            -->    <option value="Sales Coordinator">Sales Coordinator</option> 
              ...
              <tr>
                ...
                <select class="giveWidthToDrop" id="tmfrom" >
										<%
               ...
               <select class="giveWidthToDrop" id="tmto" >
										<%
                ...
                <td width="20%"> 	
                No. of Days <input type="text" onblur="myVal(this.id)" id="noOfDays" style="  width: 80px;" class="emple_1 only_float" />
                </td>
                </tr></table>
               </td>
               </tr>
             ...
             <tr>
                ...
                <td width="50%">Pin  <input type="text" onblur="myVal(this.id)" id="pin" class="only_num"/></td>
                </tr>
                </table>
                	</td>
                <tr>
              ...
              <tr>
                ...
                <tr>
                 ...
                 <td width="20%"><input type="text" onblur="myVal(this.id)" id="creditel"  disabled="disabled" placeholder="E.L." class="emple_no"/></td><td width="20%"><input type="text" onblur="myVal(this.id)" disabled="disabled" class="emple_no" id="creditsl" placeholder="S.L." /></td></tr>
                  <tr><td width="60%">No. of times availed during the year</td>
                  <td width="20%"><input type="text" onblur="myVal(this.id)" id="availedel"  disabled="disabled" placeholder="E.L." class="emple_no"/></td><td width="20%"><input type="text" onblur="myVal(this.id)" disabled="disabled"  class="emple_no" id="availedsl" placeholder="S.L." /></td></tr>
                <tr>
                </table>
                </td>
               ...
               <div id="showHistoryHiddenTasks" >
                       ...
                       <tr>
                                ...
                                <table ><tr><td width="10%">
                                          ...
                                          <textarea style="width: 100%" id="voucherRemark"  name="voucherRemark" cols="50" rows="3" placeholder="Your Reasons" onblur="myTextareaVal(this.id)"></textarea>
                                </td></tr></table>

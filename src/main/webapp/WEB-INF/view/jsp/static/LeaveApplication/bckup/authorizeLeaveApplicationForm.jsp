 ...
 <div class="form_scolling_project" id="myformLeave">
            ...
            -->    <option value="Sales Coordinator">Sales Coordinator</option> 
              ...
              <tr>
                ...
                <td width="30%"> 	
                From <input type="text" disabled="disabled" onblur="myVal(this.id)" id="fromDate" class="small_medical popupDatepicker" placeholder="dd-MM-yyyy">
                </td>
                <td width="30%"> 	
                To <input type="text" disabled="disabled" onblur="myVal(this.id)" id="toDate" class="small_medical popupDatepicker" placeholder="dd-MM-yyyy">
                </td>
                <td width="30%"> 	
                No. of Days <input type="text" disabled="disabled" onblur="myVal(this.id)" id="noOfDays" class="emple_1" />
                </td>
                </tr></table>
               </td>
               </tr>
               ...
               <%} %>
				...
				<tr>
					<td width="50%" colspan="5">
						<table width="100%">
							<tr>
								<td colspan="3" width="100%">(For Personnel Officer)</td>
							</tr>
							<tr>

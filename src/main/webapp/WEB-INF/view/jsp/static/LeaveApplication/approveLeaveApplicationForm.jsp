	...
	submitForm('purchaseRequisitionRequest::Purchase Requisition Request');
		...
		if(dec=='accept')
		{
		 ...
		 if($("#empName").val()==null || $("#empName").val().trim()=="")
			...
			showMsgWF("Please Fill email of Personnel Officer!");
			 ...
			 else if($("#authorizationStep").val()==null || $("#authorizationStep").val().trim()=="index")
			{
			pg=false;
		...
		if(pg==true)
			...
			try{
				...
				today = dd+'-'+mm+'-'+yyyy;
				if(dec=="accept"){
				$('#historyHiddenTasks').attr("value",$('#historyHiddenTasks').val()+"Recommended By " + $("#approvalStep").val()+" on Dated "+today+",") ;
				$('#approvedBy').attr("value",$("#approvalStep").val()+" on Dated "+today) ;$('#formSStatus').attr("value","") ;
				$('#formSStatus').attr("value","Recommended") ;
 ...
 <div class="form_scolling_project" id="myformLeave">
            ...
            -->    <option value="Sales Coordinator">Sales Coordinator</option> 
              ...
              <tr>
                ...
                <select class="giveWidthToDrop" id="tmfrom" disabled="disabled">
										<%
	                   NumberFormat formatterfrom = new DecimalFormat("00");  
	                   for(int i=00;i<=11;i++){
	                   %>
	                   <option value='<%=formatterfrom.format(i)+":00 AM" %>'><%=formatterfrom.format(i) %>:00 AM</option>
	                 <%if(i==9){ %>
	                   <option selected="selected" value='<%=formatterfrom.format(i)+":30 AM" %>'><%=formatterfrom.format(i) %>:30 AM</option>
					  <%}else{ %>
					   <option value='<%=formatterfrom.format(i)+":30 AM" %>'><%=formatterfrom.format(i) %>:30 AM</option>
					  <%} %>
					   <%} %>
					...
					<%
	                   ...
	                   <option value='<%=formatterfrom.format(i)+":00 PM" %>'><%=formatterfrom.format(i) %>:00 PM</option>
	                  
	                   <option value='<%=formatterfrom.format(i)+":30 PM" %>'><%=formatterfrom.format(i) %>:30 PM</option>
						<%} %>
									</select>
                </td>
                <td width="35%"> 	
            ...
            <select class="giveWidthToDrop" id="tmto" disabled="disabled">
										<%
                ...
                <td width="20%"> 	
                No. of Days <input disabled="disabled" type="text" style="  width: 80px;"  onblur="myVal(this.id)" id="noOfDays" class="emple_1" />
                </td>
                </tr></table>
               </td>
               </tr>
             ...
             <tr>
                ...
                <td width="80%"> 	   <textarea  disabled="disabled"  style="width: 100%" id="leaveReason"   name="leaveReason" cols="50" rows="3" placeholder="Your Reasons" onblur="myTextareaVal(this.id)"></textarea></td></tr></table>
               </td>
               </tr>
                ...
                <td width="80%"> 	   <textarea  disabled="disabled" style="width: 100%" id="leaveAddr"   name="leaveAddr" cols="50" rows="3" placeholder="Your Address" onblur="myTextareaVal(this.id)"></textarea></td></tr>
                <tr>
                <td width="20%"></td>
                <td width="80%"> 
                <table width="100%">
                ...
                <td width="50%">Pin  <input disabled="disabled" type="text"  onblur="myVal(this.id)" id="pin" /></td>
                </tr>
                </table>
                	</td>
                <tr>
            ...
            <tr>
               <!--  <td  width="30%" colspan="2">
                Recommending Authority <br><input disabled="disabled" type="text" onblur="myVal(this.id)" class="emple_np" id="verificationStep" placeholder="Email"/>
                </td> -->
                <td style="display: none;" width="35%" colspan="3">
                Personnel Officer 
                <!-- <input disabled="disabled" type="text" onblur="myVal(this.id)" class="emple_np" id="approvalStep" placeholder="Email"/> -->
               ...
               <%} %>
                ...
                <!-- <input disabled="disabled" type="text" onblur="myVal(this.id)" class="emple_np" id="authorizationStep" placeholder="Email"/> -->
                </td>
             ...
             <td colspan="8">
                ...
                <td width="85%"><input disabled="disabled" type="text"  onblur="myVal(this.id)"  style="width: 65% !important; border: 0px;" readonly="readonly" value="" id="employeeID" name="employeeID"  /></td>
                </tr>
                </table>
              ...
              <tr>
               <td colspan="8">
                <table>
                <tr>
                <td width="10%"> Sanctioned By</td>
                <td width="85%"><input disabled="disabled" type="text" onblur="myVal(this.id)" style="width: 65% !important; border: 0px;" readonly="readonly" value="" id="authorizedBy" name="authorizedBy"  /></td>
                </tr>
                </table>
				...
				<tr>
					<td colspan="8"><div class="table_right">
						...
						<input  type="button" id="CPVAppr"
									...
									value="Recommend" onclick="valiForm(this.id,'accept')">
								<!----------/// ADD USER END -------->
								<!----------/// User List ----------->
								<!--   <div class="Logged_User_tab  onclick">CANCEL</div> -->
								<input id="rejlev" type="button" class="Logged_User_tab  onclick"

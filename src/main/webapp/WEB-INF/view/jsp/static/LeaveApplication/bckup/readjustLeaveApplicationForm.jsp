 ...
 <div class="form_scolling_project" id="myformLeave">
			...
			<tr>
             ...
             <input type="hidden" value="<%=dt %>" name="filledDaete" id="filledDaete" />  
                ...
                <input type="hidden"  name="formSStatus"  id="formSStatus" />
                   Date:<input type="text" onblur="myVal(this.id)" class="small_medical popupDatepicker" value="<%=dt %>" id="curr_Date"  placeholder="dd-MM-yyyy"></td>
              </tr>
              <tr>
             ...
             <tr>
                ...
                <td width="60%">  <select  name="empDesig" style="height: 28px;" id="empDesig">
            ...
            -->    <option value="Sales Coordinator">Sales Coordinator</option> 
             ...
             <tr>
                ...
                <td width="80%"> 	   <textarea style="width: 100%" id="leaveReason"  mane="leaveReason" cols="50" rows="3" placeholder="Your Reasons" onblur="myTextareaVal(this.id)"></textarea></td></tr></table>
               </td>
               </tr>
                ...
                <td width="80%"> 	   <textarea style="width: 100%" id="leaveAddr"  mane="leaveAddr" cols="50" rows="3" placeholder="Your Address" onblur="myTextareaVal(this.id)"></textarea></td></tr>
                <tr>
                <td width="20%"></td>
                <td width="80%"> 
                <table width="100%">

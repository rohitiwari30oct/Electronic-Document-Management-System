...
function valiForm(id){
	...
	submitForm('purchaseRequisitionRequest::Purchase Requisition Request');
		...
		var pg=true;
		 if($('input[name="leaveGranted"]:checked').length<=0)
			{
			pg=false;
			showMsgWF("Please done work of Sanctioning Authority!");
			} 
		...
		if(pg==true)
			...
			try{
				...
				today = dd+'-'+mm+'-'+yyyy;
				$('#historyHiddenTasks').attr("value",$('#historyHiddenTasks').val()+"Approved By " + $("#authorizationStep").val()+" on Dated "+today) ;
					$("#authorizedBy").attr("value",$("#authorizationStep").val()+" on Dated "+$("#filledDaete").val() );
...
function setLeaveGranted(val)
{
//	alert("hii");
$(':radio[name="leaveGranted"]').removeAttr('checked');
$(':radio[name="leaveGranted"][id='+val+']').attr('checked', 'checked');
}
 ...
 <div class="form_scolling_project" id="myformLeave">
            ...
            <table id="handleWorkflowForm">
             ...
             <input type="hidden" value="Leave Application Form" name="formNameWF" id="formNameWF" /> 
              ...
              <td width="10%"><img src="images/logo.png"></td>
               ...
               <td width="10%">Date:<input type="text" disabled="disabled"  onblur="myVal(this.id)" class="small_medical popupDatepicker" value="<%=dt %>" id="curr_Date"  placeholder="dd-MM-yyyy"></td>
              </tr>
              <tr>
             ...
             <tr>
                ...
                <td width="60%"> <select style="height: 28px;" disabled="disabled"  name="empDesig"  id="empDesig">
            ...
            -->    <option value="Sales Coordinator">Sales Coordinator</option> 
               ...
               -->
                ...
                <td width="80%">
						...
						<select id="deptName" name="deptName" disabled="disabled" style="height: 28px;">
                ...
                <td width="70%">
                <select id="locationName" name="locationName" disabled="disabled" style="height: 28px;">
            ...
            <select class="giveWidthToDrop" id="tmto" disabled="disabled">
             ...
             <tr>
                ...
                <td width="80%"> 	   <textarea style="width: 100%" id="leaveReason" disabled="disabled"  name="leaveReason" cols="50" rows="3" placeholder="Your Reasons" onblur="myTextareaVal(this.id)"></textarea></td></tr></table>
               </td>
               </tr>
                ...
                <td width="80%"> 	   <textarea style="width: 100%" id="leaveAddr" disabled="disabled"  name="leaveAddr" cols="50" rows="3" placeholder="Your Address" onblur="myTextareaVal(this.id)"></textarea></td></tr>
                <tr>
                <td width="20%"></td>
                <td width="80%"> 
                <table width="100%">
                <tr>
                <td width="50%">Telephone(s)(if any) <input type="text" disabled="disabled" onblur="myVal(this.id)" id="telephone" /> </td>
                <td width="50%">Pin  <input type="text" disabled="disabled" onblur="myVal(this.id)" id="pin" /></td>
                </tr>
                </table>
                	</td>
                <tr>
            ...
            <input type="button" onclick="getHistoryForms()" class="getHistory"  value="Get History" />
					...
					<td colspan="8"><div class="table_right">
						...
						<input type="button" id="CPVAppr"
									...
									value="Approve" onclick="valiForm(this.id)">
								<!----------/// ADD USER END -------->
								<!----------/// User List ----------->

...
%>
 <div class="form_scolling_project" id="myformLeave">
            ...
            <select class="giveWidthToDrop" id="tmto" >
                ...
                <td width="20%"> 	
                No. of Days <input  type="text" style="  width: 80px;"  onblur="myVal(this.id)" id="noOfDays" class="emple_1" />
                </td>
                </tr></table>
               </td>
               </tr>
            ...
            <tr>
              ...
              <tr>
                ...
                <tr>
                 ...
                 <td width="20%"><input type="text"  onblur="myVal(this.id)" id="creditel"   placeholder="E.L." class="emple_no only_float"/></td><td width="20%"><input type="text"  onblur="myVal(this.id)"  class="emple_no only_float" id="creditsl" placeholder="S.L." /></td></tr>
                  <tr><td width="60%">No. of times availed during the year</td>
                  <td width="20%"><input type="text" onblur="myVal(this.id)" id="availedel"  placeholder="E.L." class="emple_no only_float"/></td><td width="20%"><input type="text"  onblur="myVal(this.id)"  class="emple_no only_float" id="availedsl" placeholder="S.L." /></td></tr>
                <tr>
                </table>
                </td>

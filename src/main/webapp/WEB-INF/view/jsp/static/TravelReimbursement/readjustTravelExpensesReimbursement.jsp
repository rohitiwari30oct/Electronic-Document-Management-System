			...
			<table  id="handleWorkflowForm">
				<tbody>
					<tr>
						...
						<td colspan="5" class="table_heading">TRAVEL EXPENSES REIMBURSEMENT CLAIM
                ...
                <input type="hidden"  name="formSStatus"  id="formSStatus" />
					...
					<tr class="depart_form">
						<td colspan="2">NAME
							<div class="claer"></div> <input type="text" onblur="myVal(this.id)" value="<%=uname %>"   id="empName" >
						</td>
						<td colspan="2">EMP.NO
                ...
                <option value="Workmen">Workmen </option>
					...
					<tr class="depart_form">
						...
						<td colspan="2">CLAIM FROM
							<div class="claer"></div> <input type="text" onblur="myVal(this.id)"  id="claimFrom">
						</td>
						<td>TO
							<div class="claer"></div> <input type="text" onblur="myVal(this.id)"    id="claimTo" >
						</td>
					</tr>
					<tr>
 ...
 <tr>
            ...
            <input type="button" onclick="getHistoryForms()" class="getHistory"  value="Get History" />
              ...
              <td colspan="7">   
              	...
              	<tr>
						<td colspan="7"> <input type="button"
					...
					<tr>
						<td colspan="7"><div class="table_right">
								<input type="button" id="plantpur1"
									...
									value="RESUBMIT" onclick="checkMail(this.id)"> 

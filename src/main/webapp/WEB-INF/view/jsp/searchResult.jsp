...
<div id="contactdiv_6">
  ...
  <form id="contact" class="form fileUploadForm" commandName="fileupload"  action="javascript:;" enctype="multipart/form-data" method="post" accept-charset="utf-8">
      ...
      <!--    	<div  onclick="createNewDoc()" class="upload" >Upload</div> -->

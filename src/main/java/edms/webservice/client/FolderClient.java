...
public class FolderClient extends WebServiceGatewaySupport {
	...
	public GetCountryResponse GetCountryRequest(String zipCode) {
		GetCountryRequest request = new GetCountryRequest();
		request.setName(zipCode);
		...
		GetCountryResponse response = (GetCountryResponse) getWebServiceTemplate().marshalSendAndReceive(
				...
				new SoapActionCallback(
						"http://localhost:8080/ws/GetCountryRequest"));
	...
	public GetFolderResponse getFolderRequest(String path,String userid) {
		...
		GetFolderResponse response = (GetFolderResponse) getWebServiceTemplate().marshalSendAndReceive(
				request,
				new SoapActionCallback(
	...
	public GetSharedFoldersResponse getSharedFoldersRequest(String userid) {
		...
		request.setUserid(userid);
		GetSharedFoldersResponse response = (GetSharedFoldersResponse) getWebServiceTemplate().marshalSendAndReceive(
				request,
				new SoapActionCallback(
	...
	public GetSharedFoldersByPathResponse getSharedFoldersByPathRequest(String userid,String path) {
		GetSharedFoldersByPathRequest request = new GetSharedFoldersByPathRequest();
		request.setUserid(userid);
		request.setPath(path);
		GetSharedFoldersByPathResponse response = (GetSharedFoldersByPathResponse) getWebServiceTemplate().marshalSendAndReceive(
				request,
				new SoapActionCallback(
	...
	public void printResponse(GetCountryResponse response) {
		Country country = response.getCountry();
			...
			//System.out.println();
			//System.out.println("Forecast for " + country.getName() + ", "
				//	+ country.getCapital());
	...
	public HasChildResponse hasChild(String path,String userid) {
		...
		request.setUserid(userid);
		System.out.println();
		System.out.println("Requesting forecast for " + path+" and user id is : "+userid);
		HasChildResponse response = (HasChildResponse) getWebServiceTemplate().marshalSendAndReceive(
				request,
				new SoapActionCallback(
	...
	public ShareFolderByPathResponse shareFolderByPath(String folderPath,String userid,String users,String groups,String userpermissions,String grouppermissions) {
		...
		ShareFolderByPathResponse response = (ShareFolderByPathResponse) getWebServiceTemplate().marshalSendAndReceive(
				request,
				new SoapActionCallback(
	...
	public AssignSinglePermissionResponse assignSinglePermission(
		...
		AssignSinglePermissionResponse response = (AssignSinglePermissionResponse) getWebServiceTemplate().marshalSendAndReceive(
				request,
				new SoapActionCallback(
	...
	public DeleteFolderResponse deleteFolder(String folderName, String userid) {
		...
		request.setUserid(userid);
		request.setFolderPath(folderName);
		DeleteFolderResponse deleteResponse=(DeleteFolderResponse) getWebServiceTemplate().marshalSendAndReceive(
				request,
				new SoapActionCallback(
	...
	public RecycleFolderResponse recycleFolder(String folderName, String userid) {
		...
		request.setUserid(userid);
		request.setFolderPath(folderName);
		RecycleFolderResponse deleteResponse=(RecycleFolderResponse) getWebServiceTemplate().marshalSendAndReceive(
				request,
				new SoapActionCallback(
	...
	public RestoreFolderResponse restoreFolder(String folderName, String userid) {
		...
		request.setUserid(userid);
		request.setFolderPath(folderName);
		RestoreFolderResponse deleteResponse=(RestoreFolderResponse) getWebServiceTemplate().marshalSendAndReceive(
				request,
				new SoapActionCallback(
						"http://localhost:8080/ws/restoreFolderRequest"));
		return deleteResponse;
	}
	public GetRecycledDocsResponse getRecycledDoc(String userid, String folderName) {
		GetRecycledDocsRequest request=new GetRecycledDocsRequest();
		request.setUserid(userid);
		request.setPath(folderName);
		GetRecycledDocsResponse deleteResponse=(GetRecycledDocsResponse) getWebServiceTemplate().marshalSendAndReceive(
				request,
				new SoapActionCallback(
